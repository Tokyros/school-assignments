<?php
    ...
    if ($loggedInUser['id'] === $player1['id']) {
        // $game_status['player1'] = ["id" => $loggedInUser["id"], "cards" => [2, 3], "name" => $loggedInUser["name"]];
        // $game_status['player1'] = ["id" => $loggedInUser["id"], "cards" => [3, 4], "name" => $loggedInUser["name"]];
        $game_status['player1'] = ["id" => $loggedInUser["id"], "cards" => getShuffledDeck(5), "name" => $loggedInUser["name"]];
    } else if ($loggedInUser['id'] === $player2['id']) {
        // $game_status['player2'] = ["id" => $loggedInUser["id"], "cards" => [2, 3], "name" => $loggedInUser["name"]];
